  ...
  return (
    <div className="bg-[var(--cal-bg)] rounded-lg border border-[var(--cal-border)] shadow-sm">
      ...
      <div className="px-6 py-4 border-b border-[var(--cal-border)]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--cal-text)]">Timezone</p>
              <p className="text-xs text-[var(--cal-text-muted)]">All times are shown in this timezone</p>
            </div>
          </div>
          <select
            value={timezone}
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--cal-brand)] focus:ring-offset-2 ${
                  day.enabled ? 'bg-[var(--cal-brand)]' : 'bg-gray-200'
                }`}
              >
                <span
      ...
      <div className="px-6 py-4 border-t border-[var(--cal-border)] flex items-center justify-between bg-[var(--cal-bg-subtle)] rounded-b-lg">
        ...
        <div className="flex items-center gap-3">
          {saved && (
            <span className="text-sm text-[var(--cal-success)] font-medium flex items-center gap-1.5 animate-fade-in">
